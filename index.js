...
$(document).ready(function() {
  ...
  setTimeout(function() {
    $('#introMore').animate({top : '30px', opacity : '1'}, 400);
  }, 1200);
  //title 표시
  setTimeout(function() {
    $('#introTitle').animate({bottom : '230px', opacity : '1'}, 600);
  }, 1600);
  // Icon 표시 동시 출력
  setTimeout(function() {
  ...
  //로고 / 번호표 표시
  setTimeout(function() {
    $('.menuButton').animate({top : '40px'}, 200);
  }, 2200);
  setTimeout(function() {
    $('.companyIcon').animate({top : '40px'}, 400);
  }, 2200);
  setTimeout(function() {
    $('.pageNumberBox').animate({top : String(documentHeight - 89)+'px'}, 400);
  }, 2200);
  setTimeout(function() {
...
function effectScroll(HeadLine, More, Title){
  ...
  setTimeout(function() {
    $(More).animate({top : '30px', opacity : '1'}, 500);
  }, 1200);
  setTimeout(function() {
...
$(function(){
  $('.more').mouseenter(function(){
    $('.moreBorderLine').stop().animate({width : '0px'}, 100);
  });
  $('.more').mouseleave(function(){
    $('.moreBorderLine').stop().animate({width : '70px'}, 100);
  });
});
// 메뉴 출력
